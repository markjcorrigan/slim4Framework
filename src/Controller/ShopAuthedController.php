...
class ShopAuthedController extends Controller
{
    public function default(Request $request, Response $response, array $args): Response
    {
        ...
        return $this->twig->render($response, 'defaultauthed.html.twig', $viewData);
    }
...
//        return $this->twig->render($response, 'details.html.twig', $viewData);
        ...
        return $this->twig->render($response, 'detailsauthed.html.twig', [
            'bike' => $bikes[$key]
        ]);
    }
}
